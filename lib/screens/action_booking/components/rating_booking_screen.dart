...
class RatingBookingScreen extends StatefulWidget {
  static final String routeName = '/rate';

  const RatingBookingScreen({Key? key}) : super(key: key);

  @override
  _RatingBookingScreenState createState() => _RatingBookingScreenState();
}

class _RatingBookingScreenState extends State<RatingBookingScreen> {
  @override
