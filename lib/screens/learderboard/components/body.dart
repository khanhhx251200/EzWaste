...
class _BodyState extends State<Body> {
    ...
    return Container(
      child: Column(
        children: [
          ...
          context.read<LeaderBoardProvider>().listLeaderBoard.length > 0 ? Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  color: bgColor,
                  child: ListTile(
                    title: Text('Hoàng Xuân Khánh'),
                    trailing: Text("${index * 33}đ"),
                    leading: Row(
  ...
  double getHeightRank(double topRank) {
    if (topRank == 1) {
      return 46.0;
    } else if (topRank == 2) {
      return size32;
  ...
  double getTopSize(double topRank) {
    if (topRank == 1) {
      return -size36;
    } else if (topRank == 2) {
      return -size32;
